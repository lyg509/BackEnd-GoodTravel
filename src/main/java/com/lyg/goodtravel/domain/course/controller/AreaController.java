...
import com.lyg.goodtravel.domain.course.response.AreaCountRes;
import com.lyg.goodtravel.domain.course.service.AreaCountService;
...
public class AreaController {
    ...
    public ResponseEntity<? extends BaseResponseBody> touristSearch () {
        ...
        return ResponseEntity
                .status(200)
                .body(AreaCountRes.of(200, "Success", areaCountService.searchAll()));
