...
public class CourseServiceImpl implements CourseService {
    ...
    @Override
    public Page<CourseInfo> courseListByUser(int userId, Pageable pageable) {
        return courseRepositorySpp.findCourseListByUser(userId, pageable);
    }

    @Override
    public Page<CourseInfo> popularCourse(Pageable pageable) {
        return courseRepositorySpp.findPopularCourse(pageable);
    }

    @Override
    public Page<CourseInfo> courseSearch(String courseName, Pageable pageable) {
