package com.lyg.goodtravel.domain.user.db.entity;
...
public class User {
    ...
    @ApiModelProperty(value = "회원 이름", required = true, example = "tester")
    @Column(name = "user_name")
    private String userName;

    @ApiModelProperty(value = "회원 이메일", required = true, example = "tester@kakao.com")
